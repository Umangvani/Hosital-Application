...
function Home() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-white px-5 md:px-30 mt-12 ">
      ...
      <div className="relative flex flex-wrap justify-evenly w-full gap-5 h-130  mt-5">
      {/* Top Section */} 
      <div className=" max-w-3xl py-10 ">
        ...
        <p className="text-gray-500 my-8">
          Good health is the state of mental, physical, and social well-being, and it does not <br/> just mean the absence of diseases.
        </p>
        ...
        <div className="flex  gap-10 mt-10">
          ...
          <button className="flex items-center gap-2 text-gray-700">
            <span className="p-2 rounded-full border-gray-400">▶ Watch videos</span> 
          </button>
        </div>

        <p className="mt-8 ">
          Become a member of our hospital community?{" "}
          <a href="#" className="text-blue-900 font-semibold">Sign up</a>
        </p>
...
{/* our medical services */}
      <div className="py-3 text-center">
          <h1 className='text-3xl font-normal pt-9 pb-15'>Our Medical Services</h1>
...
{/* meet our doctors */}
      <div className="text-center">
        ...
        <div className="text-center">
          <button className='bg-blue-800 px-5 py-2 rounded-xl mt-10 text-white'>See more</button>
        </div>
      ...
      <div className="mb-5 text-center">
          <h1 className='text-3xl font-normal pt-15 pb-1/2'>Patients Testimonial</h1>
          <p className='text-sm/6 text-gray-500 mb-10'>Let’s see what our happy patients says</p>

          <div className="grid grid-cols-3 gap-20">
            <Testomonial name="Sara Ali Khan" speciality="Cardiologist Patient" rating={5} review='Thanks for all the services, no doubt it is the best hospital.' imgSource={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTb6209AyYsaGjpTevaQkeS2bmDAKwyQXmXWQ&s'}  />
            <Testomonial name="Simon Targett" speciality="Neurologist Patient" rating={5} review='Thanks for all the services, no doubt it is the best hospital.' imgSource={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1IDtqoyQhAU2XKPnfIzcYc6TFF6owRjz91Q&s'} />
            <Testomonial name="Sara Ali Khan" speciality="Cardiologist Patient" rating={5} review='Thanks for all the services, no doubt it is the best hospital.' imgSource={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtsg35Ad0pnDOl0tBxO8qP0h_KRMoRtDb90g&s'} />
      ...
      <div className="mb-20 text-center">
        <h1 className='text-3xl font-normal pt-15 pb-1/2'>Subscribe To Our Newsletter</h1>
        <p className='text-sm/6 text-gray-500 mb-10'>Get latest news of our hospital</p>
        ...
        <h3 className='pb-2 text-left ml-2 text-black'>For Newsletter</h3>
          <div className="flex justify-between outline-1 outline-black/20 rounded-lg">
            ...
            <button className=' text-white m-1  px-4 py-1 rounded-md bg-blue-900 hover:bg-blue-800'>Subscribe</button>
          </div>
