        ...
        <footer className='w-full dark:bg-blue-800 text-white px-5 text-center'>
            ...
            <div className="grid grid-cols-5 pt-30 pb-20 ">
                <div className="flex flex-col item-center gap-3 ">
                    <h5 className='text-4xl text--800 font-bold '
                        style={{color: "4200FF"}}>
                        Blue 
                        <span className='font-medium text-3xl text-white'> Hospital</span>
                    </h5>
                    <p className="text-md pt-2">Providing quality healthcare with expert<br/> and advanced medical facilities.</p>
                ...
                <div className="">
                    ...
                    <ul className='text-sm'>
                        ...
                        <li className='hover:underline'><a href="https://github.com/Umangvani" target="_blank">GitHub</a></li>
            ...
            <p className="text-sm pb-2">&copy; 2025 Blue Hospital. All rights reserved.</p>
        </footer>
